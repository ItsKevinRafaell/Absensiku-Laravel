...
<body id="page-top">
    ...
    <!-- Page Wrapper -->
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
            <div class="sidebar-brand-text mx-3 text-white">Absensi Siswa</div>
        </a>
        ...
        <li class="nav-item">
            ...
            <span>Absensi Harian</span></a>
        </li>

        <li class="nav-item">
            <a class="nav-link" href="{{url('profilesiswa', auth()->user()->id)}}" >
            ...
            <!-- <ul class="navbar-nav ml-auto"> -->
                ...
                <!-- <li class="nav-item dropdown no-arrow">
                    ...
                    <!-- <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                        ...
                        <a class="dropdown-item" href="{{url('profilesiswa', auth()->user()->id)}}">
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">Klik Tombol "Logout" Dibawah Untuk Mengakhiri Sesi.</div>
    ...
    <!-- SweetAlert Js -->
    <!-- <script src="assets/admin/plugin/sweetalert/sweetalert.min.js"></script> -->
    <script src="{{ asset('assets/admin/plugin/sweetalert/sweetalert.min.js') }}"></script>

    
    <!-- Webcam Js -->
    <!-- <script src="assets/admin/plugin/webcamjs/webcam.min.js"></script> -->
    <script src="{{ asset('assets/admin/plugin/webcamjs/webcam.min.js') }}"></script>
