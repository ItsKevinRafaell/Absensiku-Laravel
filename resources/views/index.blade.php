...
<head>
    ...
    <title>ABSENSI SISWA | SMK NEGERI 1 BALIKPAPAN </title>
...
<body>
    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center">
            <h5 class="logo me-auto">
                <a href="#">SMK NEGERI 1 BALIKPAPAN</a>
            </h5>
            ...
            <div class="row">
                <div class="col-lg-5 d-flex align-items-stretch">
                    ...
                    <div class="address">
                        ...
                        <h4>Location:</h4>
                        <p>Jl. Marsma R. Iswahyudi, Sepinggan, Kecamatan Balikpapan Selatan, Kota Balikpapan, Kalimantan Timur 76115</p>
                    </div>
                    <div class="email">
                        <i class="bi bi-envelope"></i>
                        <h4>Email:</h4>
                        <p>http://www.smkn1-bpn.sch.id/ </p>
                    </div>
                    <div class="phone">
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15955.421778790296!2d116.909333!3d-1.2587947!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xfa619179c2dbe2ad!2sSMK%20Negeri%201%20Balikpapan!5e0!3m2!1sen!2sid!4v1675651546128!5m2!1sen!2sid" width="300" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
               </div>         
            </div>

            <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                <form action="forms/contact.php" name="absensiku-contact-form" method="post" role="form" class="php-email-form">
                <div class="alert alert-success alert-dismissible fade show d-none role="alert">
                    <strong>Pesan Anda Telah DiKirim!</strong> Terimakasih Telah Mengirimkan Pesan Untuk Kami.
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="subjek" id="subject" placeholder="Tulis Subjek ..." required>
                    </div>
                    <div class="form-group">
    ...
    <footer id="footer">
        <div class="container footer-bottom clearfix">
            <div class="copyright">
                &copy; Copyright <strong><span><a href="https://www.instagram.com/mela.wati_16">Kevin Rafael</a></span></strong>
            </div>
            <div class="credits">
                XI-RPL &nbsp; SMK NEGERI 1 BALIKPAPAN
            </div>
        </div>
    </footer>
    <!-- ======= Footer ======= -->
...
<script>
const scriptURL = 'https://script.google.com/macros/s/AKfycbyOEgi75Kt16FgSd29suPUrWNJterK_Sz6c7iNawsNAEp3jtnBxi2kKACRLb27qBJeu0g/exec'
const form = document.forms['absensiku-contact-form']
const btnKirim = document.querySelector('.btn-kirim')
const btnLoading = document.querySelector('.spinner-grow')
